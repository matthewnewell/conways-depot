...
APPS=(
  ...
  "the-fixer-backend|8092|/home/matthew/the-fixer/backend|AI_PROVIDER=depot .venv/bin/python app.py"
  "the-fixer-frontend|5177|/home/matthew/the-fixer/frontend|source ~/.nvm/nvm.sh && npm run dev -- --host 0.0.0.0"
  "good-plan-backend|8093|/home/matthew/good-plan/backend|AI_PROVIDER=depot .venv/bin/python app.py"
  ...
  "scope-manager-backend|8097|/home/matthew/scope-manager/backend|AI_PROVIDER=depot .venv/bin/python app.py"
  "scope-manager-frontend|5183|/home/matthew/scope-manager/frontend|source ~/.nvm/nvm.sh && npm run dev -- --host 0.0.0.0"
  "labor-supply-demand-backend|8098|/home/matthew/labor-supply-demand/backend|AI_PROVIDER=depot .venv/bin/python app.py"
  "labor-supply-demand-frontend|5184|/home/matthew/labor-supply-demand/frontend|source ~/.nvm/nvm.sh && npm run dev -- --host 0.0.0.0"
  "winmax-backend|8099|/home/matthew/winmax/backend|AI_PROVIDER=depot .venv/bin/python app.py"
  "winmax-frontend|5185|/home/matthew/winmax/frontend|source ~/.nvm/nvm.sh && npm run dev -- --host 0.0.0.0"
  "task-master-backend|8100|/home/matthew/task-master/backend|AI_PROVIDER=depot .venv/bin/python app.py"
  "task-master-frontend|5186|/home/matthew/task-master/frontend|source ~/.nvm/nvm.sh && npm run dev -- --host 0.0.0.0"
  "aarons-meadow-backend|8101|/home/matthew/aarons-meadow/backend|AI_PROVIDER=depot .venv/bin/python app.py"
