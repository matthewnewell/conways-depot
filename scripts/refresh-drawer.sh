...
APPS=(conways-depot ValueStream marti winmax the-fixer task-master good-plan aarons-meadow labor-supply-demand org-charts scan-me scope-manager lets-have-a-meeting qms reckon capability-models)  # apps using @conways/drawer
